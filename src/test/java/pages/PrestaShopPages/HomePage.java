...
public List<String> summerDressesList(){
        return BrowserUtils.getElementsText(By.xpath("//a[@class='product-name']"));
}
    //--------------------------------------------------------------------------
    // header Tabs
...
//------------------------------------------------------------------------------
    ...
    @FindBy(xpath = "//a[starts-with(@class,’product-’)]")
    public WebElement productName2;
    //Find xpath starts with
...
//
    ...
    public WebElement callUsNowHeader;

    @FindBy(xpath = "//*[@id=\"block_contact_infos\"]/div/ul/li[2]/span")
    public WebElement callUsNowFooter;

    public String getCallUsNowHeader(){
        return callUsNowHeader.getText();
    }
    public String getCallUsNowFooter(){
        return callUsNowFooter.getText();
    }
